# Servidor Import XLSX Golden v01

Structural byte-stable golden for F-FOL-008, the servidor payroll item importer.
The XLSX is intentionally small: one header row and one fictitious accepted row
for `POST /api/v1/folhas/:folha_id/importar/servidor`.
