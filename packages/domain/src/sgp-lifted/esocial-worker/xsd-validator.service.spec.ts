...
const BUILDER_XSD_REFERENCES: Record<string, string[]> = {
  ...
  'src/builders/s2501/builder.ts': ['evtContProc.xsd'],
  ...
  'src/builders/s2400/builder.ts': ['evtCdBenefIn.xsd'],
  'src/builders/s2405/builder.ts': ['evtCdBenefAlt.xsd'],
  'src/builders/s2410/builder.ts': ['evtCdBenIn.xsd'],
  'src/builders/s2416/builder.ts': ['evtCdBenAlt.xsd'],
  'src/builders/s2418/builder.ts': ['evtReativBen.xsd'],
  'src/builders/s2420/builder.ts': ['evtCdBenTerm.xsd'],
  'src/builders/s3000/builder.ts': ['evtExclusao.xsd'],
